...
Они применяются только для подготовки тестовых данных.



При обычной обработке уже существующей пользовательской записи этот этап отсутствует, поэтому он не включается в operating cost per audio minute.
...
Перед финальной сдачей необходимо сверить настройку модели в transcribe.py и оставить в delivery notes только соответствующую фактической конфигурации цифру.
